...
- If data is shared, timestamps may fall into two distinct periods
...
- Preregister under which conditions transformations will be performed
...
- Link to the preregistration in the manuscript does not work/ leads to a private OSF project  
...
- Preregister the study of publication strategy    
